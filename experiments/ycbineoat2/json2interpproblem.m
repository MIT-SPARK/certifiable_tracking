function [problem_list, gt, teaser, shapes] = json2interpproblem(problem, skip)
...
if isfield(data, "interp_cad_keypoints")
    % each should be repeated 4 times
    repvec = [1:N, repelem(1:N,4)];
    shapes = shapes(:,repvec,:);

    % shapes_interp = data(1).interp_cad_keypoints' / 1000.0;
