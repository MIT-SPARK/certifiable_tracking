...
% 
% CTASET: 
% (category-level) Certifiable Taylor-Approximate Shape Estimation & Tracking
%
...
for l = 1:problem.L
    ...
    pace_problem.weights = ones(problem.N,1);
    pace_problem.scene = reshape(problem.y(:,l),[3,problem.N]);
