function [SDP,info,sdpdata] = fast_sdp_relax(problem,kappa_user,sdpdata)
% time-efficient SDP relaxation based on Heng Yang's code.
...
if problem.regen_sdp
    ...
    %% compute multipliers
    % this part can all be precomputed, except for f.
    ...
    % moment constraints can be precomputed.
    ...
    sdpdata.A  = A;
    sdpdata.Ag = Ag;
    sdpdata.B_normalize = B_normalize;
    sdpdata.pop = pop;
    ...
    A  = sdpdata.A;
    Ag = sdpdata.Ag;
    B_normalize = sdpdata.B_normalize;
    pop = sdpdata.pop;
